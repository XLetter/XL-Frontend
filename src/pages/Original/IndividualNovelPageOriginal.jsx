  ...
  return (
    <div className="IndividualNovelPageOriginal">
        <div className="infoOfNovel">
            ...
            <button id="readFirst" onClick={handleClickOne}>첫회보기</button>
